...
function profileGetOtherDetails() {
	var url_profile = getUrlParameter('profile');
	
	var url = apiURL + "profile.php";
	var inputObj = {
		"action":"profileGetOtherDetails",
		"profile":url_profile
	};
	...
	$.post(url, inputObj, function(data)
	{
		...
		if((output.status == "true") && (output.message == 'Profile Get Other Details success'))
		{	
...
$(document).ready(function(){
	...
	if (url_profile) profileGetOtherDetails();
	else profileGetDetails();
});